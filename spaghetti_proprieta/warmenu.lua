...
local function drawSubTitle()
	if menus[currentMenu] then
		...
		drawText(menus[currentMenu].subTitle, menus[currentMenu].x + buttonTextXOffset - 0.10, y - buttonHeight / 2 + buttonTextYOffset, buttonFont, subTitleColor, buttonScale, false)
